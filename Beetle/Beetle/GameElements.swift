...
struct CollisionBitMask {
    ...
    static let ItemCategory:UInt32 = 0x1 << 2
...
extension GameScene{
    func createBird() -> SKSpriteNode {
        ...
        bird.physicsBody?.contactTestBitMask = CollisionBitMask.pillarCategory | CollisionBitMask.ItemCategory | CollisionBitMask.groundCategory
    ...
    func createWalls() -> SKNode  {
        let flowerNode = SKSpriteNode(imageNamed: "bird-01")
        ...
        flowerNode.physicsBody?.categoryBitMask = CollisionBitMask.ItemCategory
        ...
        let pipeDown = SKSpriteNode(imageNamed: "pillar")
        let PipeUp = SKSpriteNode(imageNamed: "pillar")
        
        pipeDown.position = CGPoint(x: self.frame.width + 25, y: self.frame.height / 2 + 450)
        PipeUp.position = CGPoint(x: self.frame.width + 25, y: self.frame.height / 2 - 430)
        ...
        pipeDown.zRotation = CGFloat(Double.pi)
